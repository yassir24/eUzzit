...
import { ChooseJambCardPage } from '../choose-jamb-card/choose-jamb-card.page';

@Component({
  selector: 'app-jamb',
  templateUrl: './jamb.page.html',
  styleUrls: ['./jamb.page.scss'],
})
export class JambPage implements OnInit {
  ...
  constructor(
    ...
    public events: EventsService,) { 
      ...
      this.events.subscribe('setjambprovider', (data: any) => {
